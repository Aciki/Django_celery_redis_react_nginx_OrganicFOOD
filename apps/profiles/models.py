...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="38970000000"
    )
    ...
    country = CountryField(
        verbose_name=_("Country"), default="MK", blank=False, null=False
    )
    ...
    is_buyer = models.BooleanField(
        ...
        default=False,
        help_text=_("Are you bayer"),
    )
    is_seller = models.BooleanField(
        verbose_name=_("Seller"),
        default=False,
        help_text=_("Are you seller?"),
    )
